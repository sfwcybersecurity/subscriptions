...
return new class extends Migration
{
    ...
    {
        Schema::create(config('sfw.tables.plan_subscriptions'), function (Blueprint $table) {
            $table->increments('id');
            $table->string('tag');
            ...
            $table->foreign('plan_id')->references('id')->on(config('sfw.tables.plans'))
    ...
    {
        Schema::dropIfExists(config('sfw.tables.plan_subscriptions'));
    }
};
