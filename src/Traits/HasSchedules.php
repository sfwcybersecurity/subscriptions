...
trait HasSchedules
{
    ...
    {
        return $this->hasMany(config('sfw.models.plan_subscription_schedule'), 'subscription_id', 'id');
    }
     ...
     *
     * @return HasSchedules|\sfwcybersecurity\subscriptions\Models\PlanSubscription
     */
    ...
    public function getLatestSchedule(?Carbon $date = null)
    {
        ...
        return app(config('sfw.models.plan_subscription_schedule'))
            ->pending($date)
